...
It is possible to send images with notifications. To do so, add a list of paths or absolute URLs in the notification `data`.
...
If you need to include a file from an external folder or URL in your notifications, you will have to [list the source folder or URL as allowed](/docs/configuration/basic/).
